...
{
    public partial class FormQuanLyHoiVien : Form
    {
        ...
        // =========================================================
        private const int NGUONG_BAC = 500;
        private const int NGUONG_VANG = 1000;
        private const int NGUONG_KIM_CUONG = 3000;

        public FormQuanLyHoiVien()
        {
            InitializeComponent();
